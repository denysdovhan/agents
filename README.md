...
| <img src="skills/agent-log/assets/agent-log.png" alt="Agent log icon" width="16" height="16"> [`agent-log`](skills/agent-log/SKILL.md) | Maintain an agent log of product and engineering decisions in `.agents/log`. |
